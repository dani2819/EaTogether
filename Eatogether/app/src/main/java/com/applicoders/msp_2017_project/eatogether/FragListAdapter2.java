...
public class FragListAdapter2 extends ArrayAdapter<String> {
    private final Activity context;
    private final String[] itemname;
    private final String[] guest;
    private final String[] date;

    public FragListAdapter2(Activity context, String[] itemname, String[] guest, String[] date) {
        super(context, R.layout.list_item_stats_frag2, itemname);
