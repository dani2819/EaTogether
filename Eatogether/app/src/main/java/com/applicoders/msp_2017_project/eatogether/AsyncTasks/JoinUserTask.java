...
/**
 * Created by rafay on 4/17/2017.
 */

public class JoinUserTask extends AsyncTask<Void, Void, String> {
    public static JoinUserTask instance;
    private final HashMap KVP;
    private final String CallType;
    private final String ServerResource;
    private TaskDone callingActivity;

    public JoinUserTask(TaskDone _callingActivity, HashMap _KVP, String _CallType, String _serverResource) {
        instance = this;
        KVP = _KVP;
        CallType = _CallType;
        ...
        try {
            ...
            if (jsonObj.getBoolean("success")) {
                ...
                if(callingActivity != null){
                    callingActivity.FoodEventTaskDone(data);
                }
            } else {
